...
static void init_file_name (struct intr_frame *,char *,char **,int) ;
...
start_process (void *file_name_)
{
  ...
  init_file_name(&if_,file_name,args,argc); 
...
static void
init_file_name (struct intr_frame *frame,char *file_name_,char **args,int argc) 
{
   struct intr_frame *if_ = frame;
   char *file_name = file_name_;
